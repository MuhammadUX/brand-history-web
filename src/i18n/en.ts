const en = {
  ...
  admin: {
    ...
    brands: {
      ...
      bulkDeleteConfirm:
        "Delete the selected brands permanently? Only draft or archived brands are removed; others are skipped. This can't be undone.",
      bulkArchiveConfirm: "Archive the selected brands? Already-archived ones are skipped.",
      bulkPublishConfirm:
        "Publish the selected brands? Only approved/unpublished brands that pass validation are published; the rest are skipped.",
      bulkRunning: "Working\u2026",
      bulkForbidden: "This action needs an admin.",
      bulkError: "Couldn't complete the bulk action. Please try again.",
      bulkSummaryDone: "{succeeded} done",
      bulkSummarySkipped: "{skipped} skipped",
      bulkSummaryFailed: "{failed} failed",
    },
    editor: {
      newTitle: "New brand",
      ...
      archivedFrozen:
        "This brand is archived and frozen. Ask an admin to restore it before editing.",
      archivedFrozenAdmin:
        "This brand is archived and frozen. Restore it to draft (in Publication state above) before editing.",
      forbidden: "This action needs an admin.",
      ...
      assetImage: "Image",
      assetUpload: "Upload file",
      assetUploading: "Uploading…",
      assetUploadError: "Upload failed",
      assetSuggestLogo: "Suggest logo",
      assetImagePreview: "Asset image preview",
      assetClearImage: "Clear",
      timelineTitle: "Timeline",
      tlYear: "Year",
      tlTitleEn: "Title (EN)",
      tlTitleAr: "Title (AR)",
      ...
      fontWeights: "Weights",
      fontPolicy: "Policy",
      fontSpecimenEn: "Specimen (EN)",
      fontSpecimenAr: "Specimen (AR)",
      fontFoundry: "Foundry",
      fontLicense: "License",
      fontSourceUrl: "Source URL",
      fontCssStack: "CSS stack",
      guidelinesTitle: "Guidelines",
      guidelineKind: "Kind",
      guidelineDo: "Do",
      guidelineDont: "Don't",
      guidelineTextEn: "Text (EN)",
      guidelineTextAr: "Text (AR)",
      applicationsTitle: "Applications",
      applicationContext: "Context",
      applicationImageUrl: "Image URL",
      applicationCaptionEn: "Caption (EN)",
      applicationCaptionAr: "Caption (AR)",
      applicationBgColor: "Background color",
      remove: "Remove",
      add: "Add",
      save: "Save",
      noRows: "None yet.",
    ...
    aiBuilder: {
      ...
      regionLabel: "Region",
      urlLabel: "Known URL",
      guidelinesUrlLabel: "Brand guidelines URL (PDF)",
      guidelinesUrlHint: "Link a brand-guidelines PDF and the AI will read it for the full color palette.",
      ...
      assetNameEn: "Name (English)",
      assetNameAr: "Name (Arabic)",
      colorsEmpty: "No colors were found. Add the brand's colors manually below.",
      assetsEmpty: "No assets were found. Add the brand's logos/assets manually below.",
      assetUploadNote: "Optionally upload the logo/image here; you can also add or replace it in the brand editor after the draft is created.",
      removeRow: "Remove",
      colorHexHint: "e.g. #4F008C",
      colorHexInvalid: "Enter a 6-digit hex like #4F008C",
      assetImage: "Image",
      assetUpload: "Upload file",
      assetUploading: "Uploading…",
      assetUploadError: "Upload failed",
      ...
      summaryAr: "Summary (Arabic)",
      sector: "Sector",
      sectorSuggested: "AI suggested a new sector:",
      sectorCreateNew: "Create new sector “{name}”",
      sectorCreating: "Creating sector…",
      sectorCreateError: "Couldn't create the sector. Please try again.",
      foundedYear: "Founded year",
      accept: "Accept",
      reject: "Reject",
      accepted: "Accepted",
    ...
    team: {
      title: "Team & Roles",
      subtitle: "Manage who can access the operator area and what they can do.",
      empty: "No users found.",
      colUser: "User",
      colRole: "Role",
      colJoined: "Joined",
      colAction: "Change role",
      you: "You",
      youHint: "You can't change your own role.",
      roleUser: "User",
      roleEditor: "Editor",
      roleAdmin: "Admin",
      apply: "Apply",
      applying: "Applying…",
      confirm: "Change this user's role to {role}?",
